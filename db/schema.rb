...
ActiveRecord::Schema.define(version: 20151026120910) do
  ...
  add_index "pessoas", ["confirmation_token"], name: "index_pessoas_on_confirmation_token", unique: true, using: :btree
  add_index "pessoas", ["email"], name: "index_pessoas_on_email", unique: true, using: :btree
  add_index "pessoas", ["reset_password_token"], name: "index_pessoas_on_reset_password_token", unique: true, using: :btree
